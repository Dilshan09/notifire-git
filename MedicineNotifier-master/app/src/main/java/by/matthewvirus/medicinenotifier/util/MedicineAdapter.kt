...
class MedicineAdapter(
    ...
    class MedicineHolder(
        ...
        fun bind(medicine: Medicine) {
            ...
            // Display the number of times medicine was taken today
            if (this.medicine.currentlyTaken != (this.medicine.medicineDose * this.medicine.medicineUseTimesPerDayInt) + 1) {
                ...
                currentlyTakenTextView.text = "Well played! Your reminder is confirmed. Keep up the excellent work!"
            }

            // Set medicine status icon and color based on its status
            ...
            // Display the number of medicines left in the container
            ...
            // Show warning icons and text if the medicine is running low
